...
namespace Sim.Sec.Desenvolvimento.ComercioAmbulante.ViewModel
{
    ...
    public class vmConsultaAmbulante : VMBase, IPrintBox
    {
        #region Declarations
        NavigationService ns;

        private ObservableCollection<Ambulante> _listadia = new ObservableCollection<Ambulante>();
        ...
        public ObservableCollection<Ambulante> ListarDIA
        {
        ...
        public ObservableCollection<bool> Situacoes
        {
            get { return new ObservableCollection<bool>() { true, false }; }
        }
        ...
        public ICommand CommandPrintProfile => new RelayCommand(p =>
        {
            ...
            ns.Navigate(new Uri(@"/Sim.Sec.Desenvolvimento;component/ComercioAmbulante/View/AmbulantesPrint.xaml", UriKind.RelativeOrAbsolute));
        ...
        #region Constructor
        public vmConsultaAmbulante()
        {
            GlobalNavigation.Pagina = "CONSULTA AMBULANTE";
        ...
        private async void AsyncListarAtendimento(List<string> sqlcommand)
        {
            ...
            var t = Task.Factory.StartNew(() => new Repositorio.RAmbulante().Lista_Ambulantes(sqlcommand));
            await t;
        ...
        private FlowDocument PreviewInTable(ObservableCollection<Ambulante> obj)
        {
            ...
            */
            ...
            header.Cells.Add(new TableCell(new Paragraph(new Bold(new Run("ALTERAÇÕES"))) { Padding = new Thickness(5) }) { BorderThickness = new Thickness(0.5), BorderBrush = Brushes.Black });
            header.Cells.Add(new TableCell(new Paragraph(new Bold(new Run("ATIVO"))) { Padding = new Thickness(5) }) { BorderThickness = new Thickness(0.5), BorderBrush = Brushes.Black });
            ...
            if (obj != null)
            {
                ...
                foreach (Ambulante a in obj)
                {
                    ...
                    row.Cells.Add(new TableCell(new Paragraph(new Run(a.UltimaAlteracao.ToString())) { Padding = new Thickness(5) }) { BorderThickness = new Thickness(0.5), BorderBrush = Brushes.Black });
                    row.Cells.Add(new TableCell(new Paragraph(new Run(a.Ativo.ToString())) { Padding = new Thickness(5) }) { BorderThickness = new Thickness(0.5), BorderBrush = Brushes.Black });
