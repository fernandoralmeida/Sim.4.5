...
namespace Sim.Controls
{
    ...
    ///
    ///     <MyNamespace:BarChartsTheme/>
    ///
    /// </summary>
    [TemplatePart(Name = PartBars, Type = typeof(ItemsControl))]
    [TemplatePart(Name = PartLegendas, Type = typeof(ItemsControl))]
    public class BarChartsTheme : Control
    {
        static BarChartsTheme()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BarChartsTheme), new FrameworkPropertyMetadata(typeof(BarChartsTheme)));
        }

        #region  Fields
        public const string PartBars = "PART_Bars";
        public const string PartLegendas = "PART_Leg";
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register("Title", typeof(string), typeof(BarChartsTheme), new FrameworkPropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty RelativeWidthProperty = DependencyProperty.Register("RelativeWidth", typeof(double), typeof(BarChartsTheme), new FrameworkPropertyMetadata(null));
        public static readonly DependencyProperty LegendasOnOffProperty = DependencyProperty.Register("LegendasOnOff", typeof(Visibility), typeof(BarChartsTheme), new FrameworkPropertyMetadata(null));
        /// <summary>
        /// Registers a dependency property as backing store for the Content property
        /// </summary>
        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register("Content",
            typeof(object), typeof(BarChartsTheme),
